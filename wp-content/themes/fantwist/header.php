		...
		<nav class="nav-top inner-wrap">
			...
			<?php if (is_user_logged_in()) { 
				...
				<div class="nav-menu-left">
					...
					<a class="nav-lobby <?php if (is_page('lobby')) { echo 'active'; } ?>" href="<?=home_url()?>/lobby/">
						<span><i class="fas fa-home"></i> Lobby</span>
					</a>
					
					<a class="nav-contests <?php if (is_page('my-wagers')) { echo 'active'; } ?>" href="<?=home_url()?>/my-wagers/">
						<span><i class="fas fa-list"></i> My Wagers</span>
					</a>
					
					<a class="nav-contests <?php if (is_page('scoreboard')) { echo 'active'; } ?>" href="<?=home_url()?>/scoreboard/">
						<span><i class="fas fa-table"></i> Scoreboard</span>
					</a>
					<a class="nav-leaderboard <?php if (is_page('leaderboard')) { echo 'active'; } ?>" href="<?=home_url()?>/leaderboard/">
						<span><i class="far fa-star"></i> Leaderboard</span>
					</a>
<!-- 					
					<a class="nav-howtoplay <?php if (is_page('how-to-play')) { echo 'active'; } ?>" href="<?=home_url()?>/how-to-play/">
						<span><i class="fas fa-question"></i> How to Play</span>
					</a>

					<a class="nav-howtoplay <?php if (is_page('house-rules')) { echo 'active'; } ?>" href="<?=home_url()?>/house-rules/">
						<span><i class="fas fa-home"></i> More Info - House Rules</span>
					</a>
				 -->
				</div>
				...
				<div class="nav-menu-right">
					...
					<?php 
					// require_once './templates/my-contests.php';
					...
					$open_wager_amount = get_field('open_wager_amount', 'user_'.$current_user_id);
					...
					<div class="nav-menu-right-submenu transition">
						<div class="nav-balance-wrap">
							...
							<a class="nav-submenu-item" href="<?php echo get_author_posts_url($current_user_id); ?>">My Profile - <?= get_current_user_id() ?></a>
							<a class="nav-submenu-item" href="<?=home_url()?>/my-wagers/">Open Wagers <span>$<?php echo number_format($open_wager_amount, 2); ?></span> <i class="fas fa-arrow-circle-right"></i></a>
			...
			<?php } else { ?>
				...
				<div class="nav-menu-right">
					...
					<a class="nav-signup" href="<?= home_url(); ?>/register">
		...
		<div class="login-box">
			...
			<a href="<?=home_url(); ?>/register">Sign Up</a>
	...
	<?php if (is_user_logged_in()) { ?>
		...
		<div class="mobile-menu">
			...
			<a class="mobile-menu-item" href="<?=home_url()?>/lobby/"><i class="fas fa-home"></i><span>Lobby</span></a>
			<a class="mobile-menu-item" href="<?=home_url()?>/my-wagers/"><i class="fas fa-list"></i><span>My Wagers</span></a>
			<a class="mobile-menu-item" href="<?=home_url()?>/scoreboard/"><i class="fas fa-table"></i><span>Scoreboard</span></a>
			<a class="mobile-menu-item" href="<?=home_url()?>/leaderboard/"><i class="far fa-star"></i><span>Leaders</span></a>
			<a class="mobile-menu-item" href="<?=home_url()?>/how-to-play/"><i class="fas fa-question"></i><span>How To Play</span></a>
