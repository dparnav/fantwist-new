...
function contest_register_sortable( $columns ) {
	$columns['contest_date'] = 'Contest Date (ET)';
	return $columns;
}
...
//NBA global functions

require_once(dirname(__FILE__) . '/processing-global/nba-processing.php');
...
function pariwager_processing_admin_page() {
	...
	echo '<div class="wrap">';
		...
		require_once(dirname(__FILE__) . '/nba-config.php');
		
		// NHL 
		
		require_once(dirname(__FILE__) . '/nhl-config.php');
