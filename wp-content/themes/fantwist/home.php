				...
				<div class="home-section-text centered-vertical">
					...
					<div class="home-buttons">
						...
						<?php } else { ?>
							...
							<a href="<?= home_url(); ?>/register" class="home-btn btn-signup"><i class="fas fa-user-plus"></i> &nbsp; Sign Up For Free</a>
						
						<?php } ?>
						
						<a href="<?php echo get_home_url(); ?>/how-to-play/" class="home-btn btn-learn-more"><i class="fas fa-chalkboard-teacher"></i> &nbsp; How To Play</a>
			...
			<div class="inner-wrap">
				...
				<div class="section-grid table fullwidth fixed-layout align-center">
					...
					<div class="section-grid-tile table-cell top">
						...
						<?php if (!is_user_logged_in()) { ?>
							<div class="home-grid-title"><a href="<?= home_url(); ?>/register>Sign Up</a></div>
					...
					<div class="section-grid-tile table-cell top">
						...
						<div class="home-grid-title"><a href="<?php echo get_home_url(); ?>/lobby/">Play</a></div>
