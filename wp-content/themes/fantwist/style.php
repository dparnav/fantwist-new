...
footer.footer {
    background-image: url('/fantwist-new/wp-content/uploads/2019/04/marble.jpg');
...
.contest-teamvsteam-cell.team-vs-team-bet.contest-status-in-progress, .contest-teamvsteam-cell.team-vs-team-bet.contest-status-completed,.contest-teamvsteam-cell.team-vs-team-bet-parley.contest-status-in-progress, .contest-teamvsteam-cell.team-vs-team-bet-parley.contest-status-completed {
    background-color: #8aa1b7;
    color: white;
}
.contest-teamvsteam-cell.team-vs-team-bet.contest-status-in-progress strong, .contest-teamvsteam-cell.team-vs-team-bet.contest-status-completed strong,.contest-teamvsteam-cell.team-vs-team-bet-parley.contest-status-in-progress strong, .contest-teamvsteam-cell.team-vs-team-bet-parley.contest-status-completed strong  {
	font-weight:400
}
.page-hero h2 {
    font-weight: 700;
...
.my-score-board.my-contests > .table {
    border-spacing: 0;
}
.my-score-board.my-contests .table-heading {
    height: 40px
}
.my-score-board.my-contests a.wager-row {
    background: #fff
}
.my-score-board .table-row .table-cell:first-child {
    text-align: left;
    padding-left: 15px;
}
.my-score-board .scoreboard-row {
    height: 10px;
}
.my-score-board .team-two > div {
    border-top: 1px solid #E9EEF5;
}
.my-score-board .team-name {
    font-weight: 600;
}
.my-score-board .team-name span {
    font-weight: 600;
    color:red;
}
.my-score-board .team-name span.final, .my-score-board .total-points {
    color:red;
    font-weight:600;
}
.date-selector-for-scoreboard {
    float: right;
}
.date-selector-for-scoreboard form input {
    font-weight: 600;
...
.date-selector-for-scoreboard form button {
    height: 42px;
    background: #1F375B;
    border-radius: 4px;
    border: none;
...
.page-template-parlay-contest .contest-lines-select input.wager-amount, .page-template-teaser-contest .contest-lines-select input.wager-amount{
...
input.submit-bet.show, input.submit-bet-parlay.show {
	display:inline-block;
}
input.submit-bet.disabled, input.submit-bet-parlay.disabled {
	color:#c7c7c7;
	background: #999999;
	cursor:default;
	left:0 !important;
...
.bet-ticket-sidebar.show .contest-tabs-wrap {
    display: block;
}
...
.bet-ticket-sidebar input.submit-bet, .bet-ticket-sidebar input.submit-bet-parlay {
	margin:0;
}
...
@media (min-width:1025px) {
	...
	*/
	...
	input.submit-bet:active, input.submit-bet-parlay:active{
		top:1px;
		left:1px;
	}
...
/*CUSTOM CSS*/
.team-vs-team-bet.contest-status-in-progress,.team-vs-team-bet-parley.contest-status-in-progress {
    pointer-events: none !important;
}
.team-vs-team-bet-parley.active, .team-vs-team-bet.active{
    background: #2984e0 !important;
    color:#fff !important;
}
.contest-team-vs-team-cell .parlay-betting-checkbox{
    display:none;
}
.contest-team-wrap.contest-team-vs-wrap.noselect.not-active {
    background: #8aa1b7;
}
.contest-team-wrap.contest-team-vs-wrap.noselect.not-active .team-vs-team-wrap {
    color: white;
}

.score-board-box .calender-css {
    position: absolute;
    right: 60px;
    color:black;
    top: 9px;
...
.date-selector-for-scoreboard button{
    cursor: pointer;
}
.team-vs-team-bet.contest-status-in-progress,.team-vs-team-bet-parley.contest-status-in-progress {
    pointer-events: none !important;
}
.score-boad-stats .team-league{
    vertical-align:middle !important;
}
.score-boad-stats .team-league .team-value{
    font-size:18px !important;
}
.score-boad-stats .team-name{
    width:52% !important;
}
.score-boad-stats .team-score{
    width:23% !important;
}
.score-boad-stats .team-name .team-value, .score-boad-stats .team-score .team-value{
    font-size:13px;
    line-height:3;
}
h2.section-header {
...
.contest-type-NFL .first-games.contest-team-vs-team-overunder:before {
    content: 'Over/Under';
    text-transform: uppercase;
    position: absolute;
    width: 100%;
...
.contest-type-NFL .first-games.contest-team-vs-team-pointspread:before {
	content: 'Point Spread';
    text-transform: uppercase;
    position: absolute;
    width: 100%;
...
.contest-type-NFL .first-games.contest-team-vs-team-moneyline:before {
	content: 'Moneyline';
    text-transform: uppercase;
    position: absolute;
    width: 100%;
...
.page-template-score-board .table-cell.middle.total-points, .page-template-score-board .table-cell.middle.position-points {
    width: 112px;
}
.team-name-off{
    display: block;
...
@media (max-width:767px) {
    .page-template-parlay-contest .total-winnings-proj, .page-template-teaser-contest .total-winnings-proj {
        display: none !important;
	}
    ...
    .score-board .my-contests .wager-row > .table-cell {
        min-width: auto !important;
    }

    .contest-type-NFL .contest-team-vs-team-overunder:before {
	    text-transform: uppercase;
	    position: absolute;
	    width: 100%;
	    text-align: center;
	...
	.contest-type-NFL .contest-team-vs-team-pointspread:before {
	    text-transform: uppercase;
	    position: absolute;
	    width: 100%;
	    text-align: center;
	...
	.contest-type-NFL .contest-team-vs-team-moneyline:before {
	    text-transform: uppercase;
	    position: absolute;
	    width: 100%;
	    text-align: center;
...
.confirmation-popup-box{
    ...
    padding: 25px;
    font-family: 'Lato', sans-serif;
    box-shadow: rgb(45 54 59 / 25%) 0px 1px 4px;
    z-index: 999;
}
.confirmation-popup-box .confirmation-popup-box-header{
    border-bottom: 1px solid #c3c5c9;
    position: relative;
    padding-bottom: 8px;
    margin-bottom: 24px;
...
.confirmation-popup-box .confirmation-popup-box-header .confirmation-popup-box-close{
    position: relative;
    float: right;
    font-weight: 900;
    font-size: 20px;
...
.confirmation-popup-box .confirmation-popup-box-footer{
    border-top: 1px solid #c3c5c9;
    clear: both;
    /* margin-top: 48px; */
    padding-top:16px;
}
#popupBetAmout, #popupBetType, #popupBetDetails, #popupBetTicket,#popupWagerAmount,#popupWagerStatus,#popupBetContest,#popupBetTeam,#popupWagerType,#popupWagerAmount,#popupWagerStatus,#popupcontestTitle{
    clear: both;
}
...
.confirmation-popup-box #btnYesConfirmYesNo, .confirmation-popup-box #btnYesPConfirmYesNo,#btnOkConfirmOk{
    background: linear-gradient(0deg, rgb(44, 181, 89), rgb(54, 196, 101));
    border: none;
    color: white;
    padding: 10px 20px;
...
.confirmation-popup-box #btnNoConfirmYesNo{
...
.date-selector-for-scoreboard-title {
    float: left;
}
.date-selector-for-scoreboard-title span{
    color:#519be6;
    padding-right: 10px;
}
.date-selector-for-scoreboard-title div{
    color:#111;
}
.confirmation-popup-box-body div {
    padding: 2px 0;
}
...
@media only screen and (max-width: 768px) {
    ...
    .confirmation-popup-box .confirmation-popup-box-footer button#btnNoConfirmYesNo{
        margin-left: 0;
    }
}
@media only screen and (min-width: 769px) and (max-device-width: 950px)  {
    .confirmation-popup-box{
        width: 60%;
        top: 10%;
        left: 20%;        
...
@media only screen and (min-width: 951px) and (max-device-width: 1399px)  {
    .confirmation-popup-box{
        width: 45%;
        top: 10%;
        left: 25%;        
...
.rotation-wrap{
    background: white;
    padding: 17px 20px 11px 13px;
    margin: 0px 5px;
    font-weight: 600;
    height: 128px;
}
.rotation-wrap.not-active {
    background: #8aa1b7;
    padding: 16px;
    margin: 0px 5px;
}
.rotation-wrap.not-active .team-vs-team-wrap{
    color: white;
}

#wagerAmount,#wager_game_type, .bet-setteled, #wagerResult, #wagerDisplayDate,#singleResult,#singleResultMyAccount,#contestTitle,#wager__types{
    display: none;
}
/* cursor pointer */
div.contest-click-event:hover {
    cursor: pointer;
}
div#contestBetTicket{
    font-weight: 600;
}
div#contestBetTicket:hover{
    font-weight: 400;
}
.account-wager-type{
    display: none;
...
/* h2.section-header.hide-game, .hide-game {
    display: none ;
} */
